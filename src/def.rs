...
pub const DISPLAY_BTN_TYPE_ONE_AT_A_TIME: &str = "Username, then password";
pub const DISPLAY_BTN_TYPE_USERNAME: &str = "Only Username";
pub const DISPLAY_BTN_TYPE_PASSWORD: &str = "Only Password";
